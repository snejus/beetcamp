...
class Metaguru(Helpers):
    ...
    def albumartist(self) -> str:
        ...
        * if we have a single albumartist, and it's one of the track lead artists, return
          it ignoring the rest of track artists
        * if we have more than one albumartist, and they match either track lead artists,
